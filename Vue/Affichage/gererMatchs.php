...
<div class="container rounded bg-light mt-3" >
    <div class="row">
        ...
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#LikesDeslikes">Mes Likes / Deslikes</button>
        <div class="modal fade" id="LikesDeslikes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel"><i class="far fa-grin-stars"></i> Voici vos notes ! </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <?php if ((include_once('mesNotes.php'))==1) :?>
                        <?php endif; ?>
                    </div>
                    <div class="modal-footer">
