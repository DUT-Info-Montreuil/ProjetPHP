                        ...
                        <div class="card  bg-light" >
                            ...
                            <div class="card-body">
                                ...
                                <div id="buttonsMatch">
                                    ...
                                    <button type="submit" id="buttonAjouterPhotos" class="btn btn-warning "><a id="ajouterPhotos" href='?module=ModMatchs&action=FormAjouterPhotosMatchs&id=<?= $elements['idMatch']?>'>Voir Photos</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
